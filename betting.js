...
app.post("/players/player-data", function (request, response) {
  const data = require('./app.dagastar.com/api/player-data.js');
...
app.post("/bets/active-bets", function (request, response) {
  // response.sendFile(__dirname + "/app.dagastar.com/api/active-bets.html");
  response.send(getActiveBets());
});

app.post("/bets/bet-history", function (request, response) {
  // response.sendFile(__dirname + "/app.dagastar.com/api/bets-history.html");
...
app.post("/bets/add", function (request, response) {
  ...
  // const data = require('./app.dagastar.com/api/bets-add.js');
  response.send(JSON.stringify(data));
});

app.post("/events/data", function (request, response) {
  const data = require('./app.dagastar.com/api/events-data.js');
  response.send(JSON.stringify(data));
});
